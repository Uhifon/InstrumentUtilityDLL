    ...
    public class InstrumentManager
    {
        ...
        public bool Open(string m_IOName)
        {
            ...
            try
            {
                ...
                // 初始化m_IOName指定的接口
                m_IO488.IO = (IMessage)m_IOResourceManager.Open(m_IOName, AccessMode.NO_LOCK,5000); //TCPIP0::172.17.200.11::5025::SOCKET   TCPIP0::169.254.190.65::inst0::INSTR
                return true;
            }
            catch(Exception ex)
            {
        ...
        public void Close()
        {
            try
            {
                if (m_IO488 != null&& m_IO488.IO!=null)
                {
                    m_IO488.IO.Close();
                    m_IO488 = null;
                }
        ...
        {        
            try
            {
                ...
                else if (m_IO488 != null && m_IO488.IO!=null)
                {
